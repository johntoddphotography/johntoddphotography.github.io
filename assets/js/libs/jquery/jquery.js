...
jQuery.fn.extend({
	...
	// https://blindsignals.com/index.html/2009/07/jquery-delay/
			...
			return {
				send: function( headers, complete ) {
					...
					callback = function( _, isAbort ) {
						...
						// https://helpful.knobs-dials.com/index.html/Component_returned_failure_code:_0x80040111_(NS_ERROR_NOT_AVAILABLE)
						try {
