...
Galleria.addTheme({
    ...
    this.bind("fullscreen_enter", function () {ga = true;v.setOptions("transition", false);O.addClass("open");W.css("bottom", 0);this.defineTooltip("fullscreen", R.exit_fullscreen);this.addIdleState(W, {bottom: - 31});});
    ...
    M.click(function () {if (ia && c) {v.play();} else {c = ka;v.pause();}Q.animate({top: ia ? v.getStageHeight() + 30 : 0}, {easing: "galleria", duration: 400, complete: function () {v.defineTooltip("thumblink", ia ? R.show_thumbnails : R.hide_thumbnails);M[ia ? "removeClass" : "addClass"]("open");ia = !ia;}});});
    if (s._showPopout) {
