...
// Filename: JTnew.ggsk
// Generated Thu 7. Jan 16:51:55 2016
...
function pano2vrSkin(player,base) {
	...
	this.preloadImages=function() {
		...
		preLoadImg.src=basePath + 'images/close_button__o.png';
	}
	...
	this.addSkin=function() {
		...
		this._close_button=document.createElement('div');
		this._close_button.ggId="close_button";
		this._close_button.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		this._close_button.ggVisible=true;
		this._close_button.className='ggskin ggskin_button';
		this._close_button.ggType='button';
		this._close_button.ggUpdatePosition=function() {
			this.style[domTransition]='none';
			if (this.parentNode) {
				w=this.parentNode.offsetWidth;
		...
		hs+='visibility: inherit;';
		hs+='cursor: pointer;';
		this._close_button.setAttribute('style',hs);
		this._close_button__img=document.createElement('img');
		this._close_button__img.className='ggskin ggskin_button';
		this._close_button__img.setAttribute('src',basePath + 'images/close_button.png');
		this._close_button__img.setAttribute('style','position: absolute;top: 0px;left: 0px;-webkit-user-drag:none;');
		this._close_button__img.className='ggskin ggskin_button';
		this._close_button__img['ondragstart']=function() { return false; };
		me.player.checkLoaded.push(this._close_button__img);
		this._close_button.appendChild(this._close_button__img);
		this._close_button.onclick=function () {
			parent.$.colorbox.close();
		}
		this._close_button.onmouseover=function () {
			me._close_button__img.src=basePath + 'images/close_button__o.png';
		}
		this._close_button.onmouseout=function () {
			me._close_button__img.src=basePath + 'images/close_button.png';
		}
		this.divSkin.appendChild(this._close_button);
		this.preloadImages();
